"""
Matplotlib kütüphanesinde plot dışında oluşturulabilecek bazı grafikler
"""
...
plt.stackplot(yil, oyuncu1, oyuncu2, oyuncu3, colors=["g", "y", "b"])
...
plt.pie(
    ...
    colors=colors,
    shadow=True,
    explode=(0.05, 0.05, 0.05),  # Dilimler arası mesafe
    autopct="%1.1f%%",  # %'lik yazma
)
...
# Bar Chart
"""
# 1. Liste Gün Bilgisi | 2. Liste Mesafe Bilgisi
